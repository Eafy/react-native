...
def publishProjectName = 'react-native'
def publishProjectVersion = android.defaultConfig.versionName
def publishSiteUrl = 'https://github.com/Eafy/react-native.git'
def publishGitUrl = 'scm:git@github.com:Eafy/react-native.git'
